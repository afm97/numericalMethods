void jacobiMethod(unsigned int numberOfRows, double tolerance, double matrix[numberOfRows][numberOfRows + 1], double solution[numberOfRows], unsigned int numberMaxOfIterations)
{
